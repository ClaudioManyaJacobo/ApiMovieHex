...
from infrastructure.movie_api.tmdb_movie_repository import TMDBMovieRepository
...
class MovieController:
    def __init__(self):
        ...
        movie_repository = TMDBMovieRepository() # INFRAESTRACTURE
        self.movie_service = MovieService(movie_repository) # MODELO SERVICE
    ...
    def search(self):
        ...
        return render_template('movies/movies.html', movies=movies, query=query)
